...
const categories = [
  { name: 'Clothes', image: '/imgs/2935183.png', category: 'clothes' },
  { name: 'Electronics', image: '/imgs/4472726.png', category: 'electronics' },
  { name: 'Furniture', image: '/imgs/1999171.png', category: 'furniture' },
  { name: 'Food', image: '/imgs/1261163.png', category: 'food' },
]
